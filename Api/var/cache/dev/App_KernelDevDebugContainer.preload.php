...
require __DIR__.'/Container89qVegu/App_KernelDevDebugContainer.php';
require __DIR__.'/Container89qVegu/EntityManager_9a5be93.php';
require __DIR__.'/Container89qVegu/getValidator_NotCompromisedPasswordService.php';
require __DIR__.'/Container89qVegu/getValidator_ExpressionService.php';
require __DIR__.'/Container89qVegu/getValidator_EmailService.php';
require __DIR__.'/Container89qVegu/getTwig_Runtime_SerializerService.php';
require __DIR__.'/Container89qVegu/getTwig_Runtime_SecurityCsrfService.php';
require __DIR__.'/Container89qVegu/getTwig_Runtime_HttpkernelService.php';
require __DIR__.'/Container89qVegu/getSessionService.php';
require __DIR__.'/Container89qVegu/getServicesResetterService.php';
require __DIR__.'/Container89qVegu/getSecurity_Validator_UserPasswordService.php';
require __DIR__.'/Container89qVegu/getSecurity_Logout_Listener_CsrfTokenClearingService.php';
require __DIR__.'/Container89qVegu/getSecurity_Listener_UserProviderService.php';
require __DIR__.'/Container89qVegu/getSecurity_Listener_UserChecker_MainService.php';
require __DIR__.'/Container89qVegu/getSecurity_Listener_Session_MainService.php';
require __DIR__.'/Container89qVegu/getSecurity_Listener_PasswordMigratingService.php';
require __DIR__.'/Container89qVegu/getSecurity_Listener_Main_UserProviderService.php';
require __DIR__.'/Container89qVegu/getSecurity_Listener_CsrfProtectionService.php';
require __DIR__.'/Container89qVegu/getSecurity_Listener_CheckAuthenticatorCredentialsService.php';
require __DIR__.'/Container89qVegu/getSecurity_Firewall_Map_Context_MainService.php';
require __DIR__.'/Container89qVegu/getSecurity_Firewall_Map_Context_DevService.php';
require __DIR__.'/Container89qVegu/getSecurity_Firewall_Authenticator_MainService.php';
require __DIR__.'/Container89qVegu/getSecurity_Csrf_TokenStorageService.php';
require __DIR__.'/Container89qVegu/getSecurity_ChannelListenerService.php';
require __DIR__.'/Container89qVegu/getSecurity_AccessListenerService.php';
require __DIR__.'/Container89qVegu/getSecrets_VaultService.php';
require __DIR__.'/Container89qVegu/getRouting_LoaderService.php';
require __DIR__.'/Container89qVegu/getPropertyInfo_SerializerExtractorService.php';
require __DIR__.'/Container89qVegu/getFragment_Renderer_InlineService.php';
require __DIR__.'/Container89qVegu/getErrorControllerService.php';
require __DIR__.'/Container89qVegu/getDoctrine_UuidGeneratorService.php';
require __DIR__.'/Container89qVegu/getDoctrine_UlidGeneratorService.php';
require __DIR__.'/Container89qVegu/getDoctrine_Orm_Validator_UniqueService.php';
require __DIR__.'/Container89qVegu/getDoctrine_Orm_Listeners_PdoCacheAdapterDoctrineSchemaSubscriberService.php';
require __DIR__.'/Container89qVegu/getDoctrine_Orm_Listeners_DoctrineTokenProviderSchemaSubscriberService.php';
require __DIR__.'/Container89qVegu/getDoctrine_Orm_DefaultListeners_AttachEntityListenersService.php';
require __DIR__.'/Container89qVegu/getDoctrine_Orm_DefaultEntityManager_PropertyInfoExtractorService.php';
require __DIR__.'/Container89qVegu/getDebug_Security_Voter_VoteListenerService.php';
require __DIR__.'/Container89qVegu/getDebug_Security_Voter_Security_Access_SimpleRoleVoterService.php';
require __DIR__.'/Container89qVegu/getDebug_Security_Voter_Security_Access_ExpressionVoterService.php';
require __DIR__.'/Container89qVegu/getDebug_Security_Voter_Security_Access_AuthenticatedVoterService.php';
require __DIR__.'/Container89qVegu/getDebug_Security_UserValueResolverService.php';
require __DIR__.'/Container89qVegu/getDebug_ArgumentResolver_VariadicService.php';
require __DIR__.'/Container89qVegu/getDebug_ArgumentResolver_SessionService.php';
require __DIR__.'/Container89qVegu/getDebug_ArgumentResolver_ServiceService.php';
require __DIR__.'/Container89qVegu/getDebug_ArgumentResolver_RequestAttributeService.php';
require __DIR__.'/Container89qVegu/getDebug_ArgumentResolver_RequestService.php';
require __DIR__.'/Container89qVegu/getDebug_ArgumentResolver_NotTaggedControllerService.php';
require __DIR__.'/Container89qVegu/getDebug_ArgumentResolver_DefaultService.php';
require __DIR__.'/Container89qVegu/getContainer_GetenvService.php';
require __DIR__.'/Container89qVegu/getContainer_EnvVarProcessorsLocatorService.php';
require __DIR__.'/Container89qVegu/getContainer_EnvVarProcessorService.php';
require __DIR__.'/Container89qVegu/getCache_ValidatorExpressionLanguageService.php';
require __DIR__.'/Container89qVegu/getCache_SystemClearerService.php';
require __DIR__.'/Container89qVegu/getCache_SystemService.php';
require __DIR__.'/Container89qVegu/getCache_GlobalClearerService.php';
require __DIR__.'/Container89qVegu/getCache_AppClearerService.php';
require __DIR__.'/Container89qVegu/getCache_AppService.php';
require __DIR__.'/Container89qVegu/getApiPlatform_SwaggerUi_ActionService.php';
require __DIR__.'/Container89qVegu/getApiPlatform_Swagger_Action_UiService.php';
require __DIR__.'/Container89qVegu/getApiPlatform_Openapi_OptionsService.php';
require __DIR__.'/Container89qVegu/getApiPlatform_Openapi_FactoryService.php';
require __DIR__.'/Container89qVegu/getApiPlatform_Metadata_PropertySchema_OneOfRestrictionService.php';
require __DIR__.'/Container89qVegu/getApiPlatform_Listener_View_WriteService.php';
require __DIR__.'/Container89qVegu/getApiPlatform_Listener_View_ValidateService.php';
require __DIR__.'/Container89qVegu/getApiPlatform_Listener_View_SerializeService.php';
require __DIR__.'/Container89qVegu/getApiPlatform_Listener_View_RespondService.php';
require __DIR__.'/Container89qVegu/getApiPlatform_Listener_Exception_ValidationService.php';
require __DIR__.'/Container89qVegu/getApiPlatform_Listener_ExceptionService.php';
require __DIR__.'/Container89qVegu/getApiPlatform_Jsonld_Action_ContextService.php';
require __DIR__.'/Container89qVegu/getApiPlatform_Doctrine_Orm_QueryExtension_PaginationService.php';
require __DIR__.'/Container89qVegu/getApiPlatform_Doctrine_Orm_QueryExtension_OrderService.php';
require __DIR__.'/Container89qVegu/getApiPlatform_Doctrine_Orm_QueryExtension_FilterEagerLoadingService.php';
require __DIR__.'/Container89qVegu/getApiPlatform_Doctrine_Orm_QueryExtension_FilterService.php';
require __DIR__.'/Container89qVegu/getApiPlatform_Doctrine_Orm_QueryExtension_EagerLoadingService.php';
require __DIR__.'/Container89qVegu/getApiPlatform_Doctrine_Orm_Default_SubresourceDataProviderService.php';
require __DIR__.'/Container89qVegu/getApiPlatform_Doctrine_Orm_Default_ItemDataProviderService.php';
require __DIR__.'/Container89qVegu/getApiPlatform_Doctrine_Orm_Default_CollectionDataProviderService.php';
require __DIR__.'/Container89qVegu/getApiPlatform_Doctrine_Orm_DataPersisterService.php';
require __DIR__.'/Container89qVegu/getApiPlatform_Action_PlaceholderService.php';
require __DIR__.'/Container89qVegu/getApiPlatform_Action_NotFoundService.php';
require __DIR__.'/Container89qVegu/getApiPlatform_Action_ExceptionService.php';
require __DIR__.'/Container89qVegu/getApiPlatform_Action_EntrypointService.php';
require __DIR__.'/Container89qVegu/getApiPlatform_Action_DocumentationService.php';
require __DIR__.'/Container89qVegu/getTemplateControllerService.php';
require __DIR__.'/Container89qVegu/getRedirectControllerService.php';
require __DIR__.'/Container89qVegu/getTeachersRepositoryService.php';
require __DIR__.'/Container89qVegu/getStudentRepositoryService.php';
require __DIR__.'/Container89qVegu/getClassesRepositoryService.php';
require __DIR__.'/Container89qVegu/getTeachersControllerService.php';
require __DIR__.'/Container89qVegu/getStudentsControllerService.php';
require __DIR__.'/Container89qVegu/get_Session_DeprecatedService.php';
require __DIR__.'/Container89qVegu/get_ServiceLocator_W9y3dzmService.php';
require __DIR__.'/Container89qVegu/get_ServiceLocator_KfwZsneService.php';
require __DIR__.'/Container89qVegu/get_ServiceLocator_KfbR3DYService.php';
require __DIR__.'/Container89qVegu/get_ServiceLocator_E8xlF1YService.php';
require __DIR__.'/Container89qVegu/get_ServiceLocator_470qnw1Service.php';
require __DIR__.'/Container89qVegu/get_Container_Private_TwigService.php';
require __DIR__.'/Container89qVegu/get_Container_Private_Security_Csrf_TokenManagerService.php';
require __DIR__.'/Container89qVegu/get_Container_Private_FilesystemService.php';
require __DIR__.'/Container89qVegu/get_Container_Private_CacheClearerService.php';
