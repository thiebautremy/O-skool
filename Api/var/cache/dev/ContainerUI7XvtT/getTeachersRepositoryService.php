 ...
 */
class getTeachersRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TeachersRepository' shared autowired service.
     *
     * @return \App\Repository\TeachersRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TeachersRepository.php';

        return $container->privates['App\\Repository\\TeachersRepository'] = new \App\Repository\TeachersRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
